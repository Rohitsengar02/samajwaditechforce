        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.headerActions}>
                    ...
                    <Pressable style={styles.signupBtn} onPress={() => router.push('/register' as any)}><Text style={styles.signupBtnText}>Join Us</Text></Pressable>
                </View>
            </View>
